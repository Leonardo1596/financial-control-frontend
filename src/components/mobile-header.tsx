      ...
      <div className="flex items-center gap-2">
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <Button variant="outline" size="icon" className="shrink-0 border-none bg-transparent hover:bg-slate-100">
        ...
        <Link href="/" className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold font-headline">FinTrack</h1>
        </Link>
      </div>
